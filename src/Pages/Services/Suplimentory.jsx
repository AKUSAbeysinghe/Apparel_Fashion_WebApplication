...
// export default RepairingSection;
...
//   return (
//     <div>
//       {/* Top Section: Hero Image with Text Overlay */}
//       <div 
...
//       {/* Bottom Section: Text and Call-to-Action */}
...
//     <div className="bg-white py-12">
//       <div className="container mx-auto px-4">
//         <div className="flex flex-col lg:flex-row lg:justify-center lg:items-start space-y-8 lg:space-y-0 lg:space-x-8">
...
const CombinedPage = () => {
  return (
    ...
    >
      <div className="relative z-10 bg-white rounded-lg shadow-2xl w-[96%] max-w-[1700px] mx-auto text-gray-900 font-sans">
        <RepairsSection />
        <LongevitySection />
        <InStoreSection />
        <RepairingSection />
