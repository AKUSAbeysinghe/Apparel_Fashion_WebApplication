...
// // const App = () => {
// //   return (
// //     <div className="relative min-h-screen bg-white text-gray-800 flex flex-col items-center justify-start overflow-hidden"> {/* Changed bg-black to bg-white */}
...
// //       <div className="relative z-10 bg-white rounded-lg shadow-2xl flex flex-col items-center lg:items-start w-[96vw] mx-auto mt-12"> {/* Added mt-12 for spacing the main card, removed mb-12 */}
...
// //       {/* New Section: Product Display - Changed background to match overall page, adjusted card styling */}
// //       <div className="relative z-10 w-[96vw] mx-auto p-8 md:p-12 lg:p-16"> {/* Removed bg-white, rounded-b-lg, shadow-2xl */}
// //         {/* Background image for this section, similar to the main page background */}
// //         <div
// //           className="absolute inset-0 bg-cover bg-center opacity-70 rounded-lg" // Added rounded-lg for consistency
// //           style={{
// //             backgroundImage: `url('https://placehold.co/1920x1080/222222/555555?text=Dark+Floral+Background')`, // Placeholder for dark floral background
// //             backgroundAttachment: 'fixed', // Makes the background fixed
// //           }}
// //         ></div>
// //         <div className="relative z-20 text-center mb-12 text-white"> {/* Text color changed to white */}
...
// //           {/* Product Card 1 */}
// //           <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-lg"> {/* Added bg-white, padding, rounded-lg, shadow-lg */}
