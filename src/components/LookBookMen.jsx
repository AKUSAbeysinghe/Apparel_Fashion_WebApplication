...
//         {/* Placeholder for Massimo Dutti Logo - You can replace this with an actual SVG or image */}
//         <svg
...
//       {/* Image Grid with Central Text Overlay */}
...
//         <button className="text-lg font-medium text-gray-800 uppercase tracking-wider hover:underline focus:outline-none">
//           Shop Women
//         </button>
//         <button className="text-lg font-medium text-gray-800 uppercase tracking-wider hover:underline focus:outline-none">
//           Shop Men
...
const App = () => {
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      {/* Top Background */}
      <div
        className="absolute top-0 left-[2%] w-[96%] h-[2%] bg-cover bg-center z-0"
        style={{ backgroundImage: `url(${BgImage})` }}
      />
      {/* Bottom Background */}
      <div
      ...
      <div className="relative z-10 mx-auto w-[96%] bg-white min-h-screen flex flex-col items-center justify-center p-4 md:p-8 font-sans">
        {/* Header */}
        <header className="mb-8 md:mb-12 text-center">
          <svg
            className="mx-auto mb-2 w-10 h-10 text-gray-800"
