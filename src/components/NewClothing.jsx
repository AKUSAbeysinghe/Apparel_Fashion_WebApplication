...
//         {/* Left Card (Hidden/Partially Visible) */}
...
//         {/* Right Card (Hidden/Partially Visible) */}
...
//             <h1 className="uppercase text-2xl tracking-[.4em] text-gray-800">
//               COLLECTION
//             </h1>
//           </div>
...
//             <p className="uppercase text-xl tracking-[.4em] text-gray-800 font-light mb-4">
//               SHOP<br/>NOW
//             </p>
...
const CombinedHomepage = () => {
  ...
  return (
    ...
    <div className="font-['Inter'] bg-cover bg-center bg-repeat min-h-screen" style={{ backgroundImage: `url(${BackgroundImage})` }}>
      <div className="min-h-screen bg-white w-[96%] mx-auto py-10">
        <NewCollection/>
        <Header />
        ...
        <div className="p-8 sm:p-16 flex flex-col justify-center items-center">
          <main className="max-w-4xl w-full text-center">
            ...
            <h1 className="text-4xl sm:text-6xl font-bold leading-tight text-gray-900 mb-4">YOU'LL READ<br />THIS FIRST</h1>
            <p className="text-xl italic text-gray-600 mb-8">and then you will read this line next</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left mt-16">
              <div className="border-l pl-8 border-gray-400">
                <p className="text-sm text-gray-600 leading-relaxed font-light">You will go back to read this body copy if you want to know more...</p>
              </div>
              <div className="text-gray-800">
                <p className="text-xl font-bold leading-snug">You will read this before the paragraph.</p>
              </div>
            </div>
          </main>
        </div>
