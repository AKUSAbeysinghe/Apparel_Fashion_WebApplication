...
// import BgImage from "../assets/Background/Flower.jpeg"; // Background strips image
...
// // Lookbook Section (from your first snippet)
...
//       <div className="relative z-10 w-[96%] mx-auto flex flex-col min-h-screen">
//         <Header />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left mt-16">
              <div className="border-l pl-8 border-gray-400">
                <p className="text-sm text-gray-600 leading-relaxed font-light">
                  You will go back to read this body copy if you want to know more...
                </p>
              </div>
